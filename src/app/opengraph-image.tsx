  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {["Ethereum", "Base", "Polygon", "Arbitrum", "→ Stellar"].map((label, i) => (
            <div
              key={label}
              style={{
                padding: "8px 16px",
                borderRadius: 8,
                background: i === 4 ? "rgba(76,235,168,0.08)" : "rgba(255,255,255,0.05)",
                border: i === 4 ? "1px solid rgba(76,235,168,0.25)" : "1px solid rgba(255,255,255,0.08)",
